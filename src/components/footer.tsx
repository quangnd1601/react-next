            ...
            <div className="footer-container">
                <div className="footer-grid">
                    <div className="footer-brand">
                        <img src="../../images/logo-courtify.png" alt="Courtify Logo" className="footer-logo" />
                        <p className="footer-desc">Nền tảng đặt sân và quản lý vận động viên tiên tiến nhất thế giới. Kết nối đam mê, nâng tầm trải nghiệm.</p>
                        <div className="social-links">
                            ...
                            <a href="#" className="zalo-link">Zalo</a>
                        </div>
                    </div>
                    <div className="footer-links">
                        <h4 className="footer-title">Về Courtify</h4>
                    ...
                    <div className="footer-links">
                        ...
                        <a href="#" className="footer-link">Tennis</a>
                        <a href="#" className="footer-link">Cầu lông</a>
                        <a href="#" className="footer-link">Pickleball</a>
                    </div>
                    <div className="footer-links">
                ...
                <div className="footer-bottom">
                    <p>© 2024 Courtify - Đặt sân chuyên nghiệp. Bảo lưu mọi quyền.</p>
                </div>
            </div>
        </footer>
